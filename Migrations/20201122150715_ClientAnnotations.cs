    ...
    public partial class ClientAnnotations : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Clients",
                columns: new[] { "ID", "Address", "City", "ConfirmPassword", "Country", "Email", "FirstName", "LastName", "Password", "Phone", "Zipcode", "State", "Username" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2020, 11, 22, 10, 7, 15, 108, DateTimeKind.Local).AddTicks(9953), 1 });

            migrationBuilder.InsertData(
                table: "ClientServices",
                columns: new[] { "ID", "ClientID", "Date", "ServicesID" },
                values: new object[] { 3, 1, new DateTime(2020, 11, 22, 10, 7, 15, 112, DateTimeKind.Local).AddTicks(1799), 5 });

            migrationBuilder.InsertData(
                table: "ClientServices",
                columns: new[] { "ID", "ClientID", "Date", "ServicesID" },
                values: new object[] { 2, 2, new DateTime(2020, 11, 22, 10, 7, 15, 112, DateTimeKind.Local).AddTicks(1611), 7 });
