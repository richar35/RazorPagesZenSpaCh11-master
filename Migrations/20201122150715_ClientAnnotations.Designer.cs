...
namespace RazorPages.Migrations
{
    ...
    [Migration("20201122150715_ClientAnnotations")]
            ...
            modelBuilder.Entity("RazorPages.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2020, 11, 22, 10, 7, 15, 108, DateTimeKind.Local).AddTicks(9953),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2020, 11, 22, 10, 7, 15, 112, DateTimeKind.Local).AddTicks(1611),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2020, 11, 22, 10, 7, 15, 112, DateTimeKind.Local).AddTicks(1799),
                            ServicesID = 5
                        });
                });
